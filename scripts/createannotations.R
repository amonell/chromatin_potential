...
library(biomaRt)
mm10genome <- load('E:/scrnaseqscript/mm10_refSeq.RData')
names(mm10TSSRanges) <- mm10TSSRanges$gene_name
mart = useMart(biomart = "ensembl", dataset= "mmusculus_gene_ensembl")

peaks2 <- getPeaks("E:/scrnaseqscript/foxa1_data/h2_data/H2_bedpeaksfoxa1_new.bed", sort_peaks = TRUE)
...
rtracklayer::export.bed(annotations_2, "E:/scrnaseqscript/foxa1_data/h2_data/H2_foxa1_annotations.bed")
